      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-6 mb-12 justify-center">
          {cards.map((card, index) => (
            ...
            >
              <div
                className={`relative bg-gradient-to-br ${card.color} rounded-3xl p-8 text-white shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 border border-white/10 group-hover:bg-gradient-to-br group-hover:${card.hoverColor}`}
              >
                {/* Glow effect */}
                ...
                <div className="relative z-10">
                  <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 w-fit mb-6 group-hover:bg-white/30 transition-all duration-300">
                    {card.icon}
                  </div>
                ...
                {/* Corner decoration */}
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-white/10 to-transparent rounded-bl-3xl rounded-tr-3xl"></div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-2xl px-8 py-4 shadow-lg border border-white/20">
